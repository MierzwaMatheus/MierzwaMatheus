...
```mermaid
flowchart LR
    A["🧩 Component"] --> B["🎨 Design System"]
    B --> C["📦 Product"]
    C --> D["🏛️ Architecture"]
    D --> E["☁️ Infrastructure"]

    style A fill:#1A1A18,stroke:#4D7C5F,color:#fff
    style B fill:#1A1A18,stroke:#4D7C5F,color:#fff
    style C fill:#1A1A18,stroke:#C4664A,color:#fff
    style D fill:#1A1A18,stroke:#C4664A,color:#fff
...
```mermaid
flowchart LR
    PRD["📋 PRD"] --> DS["🎨 Design System"] --> ARCH["🏛️ Documented Architecture"] --> CODE["⌨️ First line of code"]

    style PRD fill:#0d1117,stroke:#4D7C5F,color:#fff
    style DS fill:#0d1117,stroke:#4D7C5F,color:#fff
    style ARCH fill:#0d1117,stroke:#4D7C5F,color:#fff
    style CODE fill:#0d1117,stroke:#C4664A,color:#fff
```
...
![Microsoft Entra ID](https://img.shields.io/badge/Entra%20ID-0078D4?style=flat-square&logo=microsoftazure&logoColor=white)
![JWT RS256](https://img.shields.io/badge/JWT%20RS256-000000?style=flat-square&logo=jsonwebtokens&logoColor=white)
![RBAC / ReBAC](https://img.shields.io/badge/RBAC%20%2F%20ReBAC-4D7C5F?style=flat-square&logoColor=white)
...
![WCAG](https://img.shields.io/badge/WCAG%20A11y-005A9C?style=flat-square&logoColor=white)
![RAG](https://img.shields.io/badge/RAG-FF6F00?style=flat-square&logoColor=white)
![MCP](https://img.shields.io/badge/Model%20Context%20Protocol-8E44AD?style=flat-square&logoColor=white)
...
<img height="170" src="https://github-readme-stats.vercel.app/api?username=MierzwaMatheus&show_icons=true&hide_border=true&theme=tokyonight&include_all_commits=true&count_private=true" alt="GitHub Stats" />
<img height="170" src="https://github-readme-stats.vercel.app/api/top-langs/?username=MierzwaMatheus&layout=compact&hide_border=true&theme=tokyonight&langs_count=8" alt="Top Languages" />

<br />

<img src="https://github-readme-streak-stats.herokuapp.com/?user=MierzwaMatheus&hide_border=true&theme=tokyonight" alt="GitHub Streak" />
...
<sub>🌎 <b>English</b> (Full Professional) · <b>Português</b> (Native) · <b>Español</b> (Limited Working)</sub>

<br /><br />

<img src="https://komarev.com/ghpvc/?username=MierzwaMatheus&style=flat-square&color=4D7C5F&label=Profile+Views" alt="Profile Views" />
